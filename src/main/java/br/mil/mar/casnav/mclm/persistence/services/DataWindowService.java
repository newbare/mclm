	...
	public String getWindow(String data) {
		...
		try {
			...
			if ( utes.size() > 0 ) {
				...
				throw new Exception("N�o foi encontrada correspond�ncia entre os dados da camada " + nodeData.getLayerAlias() +
						" e a tabela " + dataWindow.getSourceTable() + " no banco " + databaseConn + " usando o crit�rio [" + relationShip + "]");
			}
