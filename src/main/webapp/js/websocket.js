...
function startWebSocket( shipsHelper ) {
	...
	var mySocket = new WebSocket("ws://localhost:8080/mclm/websocket");
	...
	mySocket.onmessage = function(event) {
		...
		shipsHelper.updateLayer( event.data );
	};
	...
	mySocket.onerror = function(event) {
		console.log( "There was an error with your websocket. Dont run this on Tomcat below 8.0.");	
	};
